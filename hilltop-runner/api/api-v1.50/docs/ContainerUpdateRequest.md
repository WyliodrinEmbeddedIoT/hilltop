...
**blkio_weight_device** | Option<[**Vec<models::ResourcesBlkioWeightDeviceInner>**](ResourcesBlkioWeightDeviceInner.md)> | Block IO weight (relative device weight) in the form:  ``` [{\"Path\": \"device_path\", \"Weight\": weight}] ```  | [optional]
