...
pub async fn task_inspect(configuration: &configuration::Configuration, id: &str) -> Result<models::Task, Error<TaskInspectError>> {
...
pub async fn task_list(configuration: &configuration::Configuration, filters: Option<&str>) -> Result<Vec<models::Task>, Error<TaskListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn task_logs(configuration: &configuration::Configuration, id: &str, details: Option<bool>, follow: Option<bool>, stdout: Option<bool>, stderr: Option<bool>, since: Option<i32>, timestamps: Option<bool>, tail: Option<&str>) -> Result<reqwest::Response, Error<TaskLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    let uri_str = format!("{}/tasks/{id}/logs", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
