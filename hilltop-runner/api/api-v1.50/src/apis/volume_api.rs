...
pub async fn volume_create(configuration: &configuration::Configuration, volume_config: models::VolumeCreateOptions) -> Result<models::Volume, Error<VolumeCreateError>> {
