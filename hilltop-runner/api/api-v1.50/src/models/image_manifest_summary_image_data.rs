...
pub struct ImageManifestSummaryImageData {
    ...
    pub platform: Option<Box<models::OciPlatform>>,
...
impl ImageManifestSummaryImageData {
    ...
    pub fn new(platform: Option<models::OciPlatform>, containers: Vec<String>, size: models::ImageManifestSummaryImageDataSize) -> ImageManifestSummaryImageData {
        ImageManifestSummaryImageData {
            platform: if let Some(x) = platform {Some(Box::new(x))} else {None},
            containers,
            size: Box::new(size),
        }
    }
