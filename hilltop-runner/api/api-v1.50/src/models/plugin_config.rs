...
impl PluginConfig {
    ...
    pub fn new(description: String, documentation: String, interface: models::PluginConfigInterface, entrypoint: Vec<String>, work_dir: String, network: models::PluginConfigNetwork, linux: models::PluginConfigLinux, propagated_mount: String, ipc_host: bool, pid_host: bool, mounts: Vec<models::PluginMount>, env: Vec<models::PluginEnv>, args: models::PluginConfigArgs) -> PluginConfig {
        PluginConfig {
            docker_version: None,
            description,
            documentation,
