...
**info** | Option<[**models::ClusterVolumeInfo**](ClusterVolumeInfo.md)> |  | [optional]
**publish_status** | Option<[**Vec<models::ClusterVolumePublishStatusInner>**](ClusterVolumePublishStatusInner.md)> | The status of the volume as it pertains to its publishing and use on specific nodes  | [optional]
