...
**ports** | Option<[**Vec<models::PortSummary>**](PortSummary.md)> | Port-mappings for the container. | [optional]
...
**health** | Option<[**models::ContainerSummaryHealth**](ContainerSummaryHealth.md)> |  | [optional]
