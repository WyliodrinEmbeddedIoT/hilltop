...
> models::NetworkInspect network_inspect(id, verbose, scope)
Inspect a network
...
[**models::NetworkInspect**](NetworkInspect.md)
...
> Vec<models::NetworkSummary> network_list(filters)
List networks
...
[**Vec<models::NetworkSummary>**](NetworkSummary.md)
