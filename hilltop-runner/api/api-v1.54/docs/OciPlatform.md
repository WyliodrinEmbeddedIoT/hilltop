...
**os_version** | Option<**String**> | Optional field specifying the operating system version, for example on Windows `10.0.19041.1165`.  | [optional]
**os_features** | Option<**Vec<String>**> | Optional field specifying an array of strings, each listing a required OS feature (for example on Windows `win32k`).  | [optional]
