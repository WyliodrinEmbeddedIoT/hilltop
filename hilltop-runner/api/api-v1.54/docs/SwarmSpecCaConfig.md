...
**external_cas** | Option<[**Vec<models::SwarmSpecCaConfigExternalCasInner>**](SwarmSpecCAConfigExternalCAsInner.md)> | Configuration for forwarding signing requests to an external certificate authority.  | [optional]
