...
> models::AuthResponse system_auth(auth_config)
...
> models::SystemDataUsageResponse system_data_usage(r#type, verbose)
...
**verbose** | Option<**bool**> | Show detailed information on space usage.  |  |[default to false]
...
- **Content-Type**: Not defined
- **Accept**: application/jsonl, application/x-ndjson, application/json-seq
