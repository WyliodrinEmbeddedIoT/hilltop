...
**preferences** | Option<[**Vec<models::TaskSpecPlacementPreferencesInner>**](TaskSpecPlacementPreferencesInner.md)> | Preferences provide a way to make the scheduler aware of factors such as topology. They are provided in order from highest to lowest precedence.  | [optional]
