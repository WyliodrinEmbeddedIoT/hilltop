...
/// ContainerCpuUsage : All CPU stats aggregated since container inception. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContainerCpuUsage {
    /// Total CPU time consumed in nanoseconds (Linux) or 100's of nanoseconds (Windows). 
    #[serde(rename = "total_usage", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "percpu_usage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub percpu_usage: Option<Option<Vec<i32>>>,
    ...
    #[serde(rename = "usage_in_kernelmode", skip_serializing_if = "Option::is_none")]
    pub usage_in_kernelmode: Option<i32>,
    ...
    #[serde(rename = "usage_in_usermode", skip_serializing_if = "Option::is_none")]
    pub usage_in_usermode: Option<i32>,
}

impl ContainerCpuUsage {
    /// All CPU stats aggregated since container inception. 
    pub fn new() -> ContainerCpuUsage {
        ContainerCpuUsage {
            total_usage: None,
            percpu_usage: None,
