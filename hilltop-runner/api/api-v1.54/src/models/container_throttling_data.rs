...
/// ContainerThrottlingData : CPU throttling stats of the container.  This type is Linux-specific and omitted for Windows containers. 
...
pub struct ContainerThrottlingData {
    ...
    #[serde(rename = "throttled_periods", skip_serializing_if = "Option::is_none")]
    pub throttled_periods: Option<i32>,
    /// Aggregated time (in nanoseconds) the container was throttled for. 
    #[serde(rename = "throttled_time", skip_serializing_if = "Option::is_none")]
...
impl ContainerThrottlingData {
    ...
    pub fn new() -> ContainerThrottlingData {
