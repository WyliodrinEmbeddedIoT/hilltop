...
/// ContainersDiskUsage : represents system data usage information for container resources. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContainersDiskUsage {
    /// Count of active containers. 
    #[serde(rename = "ActiveCount", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "Reclaimable", skip_serializing_if = "Option::is_none")]
