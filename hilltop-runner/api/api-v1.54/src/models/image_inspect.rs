...
pub struct ImageInspect {
    ...
    pub descriptor: Option<Box<models::OciDescriptor>>,
    ...
    #[serde(rename = "Manifests", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub manifests: Option<Option<Vec<models::ImageManifestSummary>>>,
    ...
    #[serde(rename = "Variant", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
