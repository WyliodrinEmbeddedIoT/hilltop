...
impl ImageSummary {
    pub fn new(id: String, parent_id: String, repo_tags: Vec<String>, repo_digests: Vec<String>, created: i32, size: i64, shared_size: i64, labels: std::collections::HashMap<String, String>, containers: i32) -> ImageSummary {
        ImageSummary {
            id,
            parent_id,
            repo_tags,
