...
/// NetworkConnectRequest : NetworkConnectRequest represents the data to be used to connect a container to a network. 
...
impl NetworkConnectRequest {
    ...
    pub fn new(container: String) -> NetworkConnectRequest {
