...
pub struct OciDescriptor {
    ...
    pub platform: Option<Option<Box<models::OciPlatform>>>,
    /// ArtifactType is the IANA media type of this artifact.
    #[serde(rename = "artifactType", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub artifact_type: Option<Option<String>>,
}
