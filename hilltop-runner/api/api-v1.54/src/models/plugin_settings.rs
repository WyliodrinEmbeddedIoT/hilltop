...
/// PluginSettings : user-configurable settings for the plugin.
...
impl PluginSettings {
    ...
    pub fn new(mounts: Vec<models::PluginMount>, env: Vec<String>, args: Vec<String>, devices: Vec<models::PluginDevice>) -> PluginSettings {
        PluginSettings {
            mounts,
            env,
            args,
