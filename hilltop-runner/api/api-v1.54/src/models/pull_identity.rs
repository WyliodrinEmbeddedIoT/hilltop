...
/// PullIdentity : PullIdentity contains remote location information if image was created via pull. If image was pulled via mirror, this contains the original repository location.
