...
/// SignatureTimestampType : SignatureTimestampType is the type of timestamp used in the signature.
...
impl std::fmt::Display for SignatureTimestampType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Tlog => write!(f, "Tlog"),
            Self::TimestampAuthority => write!(f, "TimestampAuthority"),
        }
    }
}
