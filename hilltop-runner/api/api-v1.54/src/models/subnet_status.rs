...
pub struct SubnetStatus {
    ...
    #[serde(rename = "IPsInUse", skip_serializing_if = "Option::is_none")]
    pub ips_in_use: Option<i32>,
    ...
    #[serde(rename = "DynamicIPsAvailable", skip_serializing_if = "Option::is_none")]
    pub dynamic_ips_available: Option<i32>,
}
