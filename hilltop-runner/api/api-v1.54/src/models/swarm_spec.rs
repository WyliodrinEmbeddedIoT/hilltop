...
pub struct SwarmSpec {
    ...
    #[serde(rename = "Orchestration", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "Dispatcher", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub dispatcher: Option<Option<Box<models::SwarmSpecDispatcher>>>,
    #[serde(rename = "CAConfig", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
