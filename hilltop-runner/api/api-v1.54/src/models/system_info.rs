...
pub struct SystemInfo {
    ...
    #[serde(rename = "RegistryConfig", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "FirewallBackend", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub firewall_backend: Option<Option<Box<models::FirewallInfo>>>,
    ...
    #[serde(rename = "DiscoveredDevices", skip_serializing_if = "Option::is_none")]
    pub discovered_devices: Option<Vec<models::DeviceInfo>>,
    #[serde(rename = "NRI", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub nri: Option<Option<Box<models::NriInfo>>>,
    ...
    #[serde(rename = "Containerd", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
