...
pub struct TaskSpecContainerSpecPrivileges {
    ...
    pub credential_spec: Option<Box<models::TaskSpecContainerSpecPrivilegesCredentialSpec>>,
    #[serde(rename = "SELinuxContext", skip_serializing_if = "Option::is_none")]
    pub se_linux_context: Option<Box<models::TaskSpecContainerSpecPrivilegesSeLinuxContext>>,
