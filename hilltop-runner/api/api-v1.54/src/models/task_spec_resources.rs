...
pub struct TaskSpecResources {
    ...
    #[serde(rename = "SwapBytes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub swap_bytes: Option<Option<i64>>,
    ...
    #[serde(rename = "MemorySwappiness", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub memory_swappiness: Option<Option<i64>>,
}
